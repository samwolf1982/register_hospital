...
class m180203_121547_create_doctor_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('doctor', [
            ...
            'photo' => $this->text()->null()->comment('Фотография'),
        ]);
...
//        ]);
        ...
        foreach (range(1,500) as $i){
            $doc_list[]= [ $faker->firstName,$faker->firstName,$faker->lastName,$faker->numberBetween(1,4),$faker->numberBetween(1,6),$faker->numberBetween(1,$count_prof),'/image/NO-IMAGE-AVAILABLE-300x300.jpg'];
        }
        $this->batchInsert('{{%doctor}}', ['name', 'surname','patronymic','status_id','area_id','profession_id','photo'],
            $doc_list
        );
