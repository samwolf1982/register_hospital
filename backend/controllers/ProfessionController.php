...
//        ];
    ...
    {
     $c=   Doctor::find()->where(['profession_id'=>$id])->count('id');
     yii::error($c);
        if ($c==0){
            $this->findModel($id)->delete();
        }else{
            throw new ConflictHttpException ( 'Похоже кто то еще использует данную специализацию. Удалите врачей или измените их специализацию.',404);
        }
